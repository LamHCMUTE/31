    ...
    return(
        <>
            <Stack flexDirection={'column'} sx={{ backgroundColor: '#262626', height:'100%' }}>
                <Stack flexDirection={'row'} sx={{ backgroundColor: '#262626', height:'100%' }}>
                    <Stack>
                        <Stack sx={{
                    ...
                    <Button><BorderColorIcon sx={{ fontSize: '20px', color: 'white', ml:'50px', alignItems:'center' }} />
                    </Button>
                </Stack>
                ...
                <Box sx={{ width: '100%', typography: 'body1' }}>
                    <TabContext value={value}>
                        <Box sx={{ borderBottom: 1 }}>
                            <TabList onChange={handleChange} aria-label="lab API tabs example" sx={{backgroundColor:"black", m:'25px 10px',borderRadius:'10px', padding:'2px 55px',alignItems:'center'}} >
